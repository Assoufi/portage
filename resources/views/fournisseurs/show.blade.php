                    ...
                    <tbody>
                        @foreach($fournisseur->missions as $mission)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">{{ $mission->client->nom }}</td>
                                <td class="px-6 py-4">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Coût (missions)</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @php
                            $maxCout = $evolution->max('cout');
                            $maxMontant = $evolution->max('montant_factures');
                            $maxVal = max($maxCout, $maxMontant, 1);
                        @endphp
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <div class="w-32 bg-gray-200 rounded-full h-2.5">
                                            <div class="bg-purple-500 h-2.5 rounded-full" style="width: {{ $maxCout > 0 ? ($row['cout'] / $maxCout * 100) : 0 }}%"></div>
                                        </div>
                                        <span class="font-semibold text-purple-600 text-sm whitespace-nowrap">{{ number_format($row['cout'], 0) }} MAD</span>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <span class="font-semibold text-orange-600 text-sm whitespace-nowrap">{{ number_format($row['montant_factures'], 0) }} MAD</span>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
