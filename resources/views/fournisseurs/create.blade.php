...
@section('content')
    <div x-data="fournisseurForm()" x-init="init()" class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form method="POST" action="{{ route('fournisseurs.store') }}" @submit.prevent="validateAndSubmit">
                @csrf
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    ...
                    <button type="submit" 
                        ...
                        <span x-show="!isSubmitting">Créer le fournisseur</span>
        ...
        function fournisseurForm() {
            return {
                form: {
                    ...
                    taux: '{{ old('taux', 0) }}',
                    ville: '{{ old('ville', '') }}',
                    nom_responsable: '{{ old('nom_responsable', '') }}',
                    rib: '{{ old('rib', '') }}',
                    statut: '{{ old('statut', '1') }}'
                },
                errors: {},
